...
# the weird main conditional says only run the indented code if you are running this file
# from the command line otherwise if importing from this file, ignore the stuff below
